...
Pass the context as variables; render them via `{{var}}` in the prompt. See [Dynamic Prompt Variables](/guides/dynamic-variables) for call-start variables and [Inject Context](/guides/inject-context) for live updates mid-call.
